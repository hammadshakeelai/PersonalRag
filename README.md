<div align="center">
  <img src="assets/banner.png" alt="Ultra-RAG - hybrid retrieval, cross-encoder reranking, and every answer cited back to the exact page" width="100%">
</div>
...
[![Deploy to GitHub Pages](https://github.com/hammadshakeelai/PersonalRag/actions/workflows/deploy.yml/badge.svg)](https://github.com/hammadshakeelai/PersonalRag/actions/workflows/deploy.yml)
...
![Backend](https://img.shields.io/badge/backend-FastAPI%20%2B%20PyMuPDF-7C5CFF?style=flat-square)
![Keys](https://img.shields.io/badge/keys-BYOK%20%C2%B7%20zero%20server%20storage-10B981?style=flat-square)
...
git clone https://github.com/hammadshakeelai/PersonalRag.git
...
1. Create a repository on GitHub (e.g. `PersonalRag`) and push this codebase:
   ...
   git branch -M main
   git remote add origin https://github.com/hammadshakeelai/PersonalRag.git
...
4. The included workflow (`.github/workflows/deploy.yml`) will automatically build and publish your website at:
   `https://hammadshakeelai.github.io/PersonalRag/`
